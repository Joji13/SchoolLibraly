...
namespace SchoolLibraly.Infrastructure.DebugServices
{
    class DebugBooksRepository : IRepository<Book>
    {
        ...
        public Book Edit(Book item) { throw new NotImplementedException(); }

        public async Task<Book> EditAsync(Book item, CancellationToken Cancel = default) { throw new NotImplementedException(); }
